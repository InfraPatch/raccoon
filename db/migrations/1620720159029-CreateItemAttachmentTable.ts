  ...
  implements MigrationInterface
{
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      'ALTER TABLE `filledItemAttachments` ADD CONSTRAINT `FK_401de4f46d12ecd4bf87db46646` FOREIGN KEY (`filledItemId`) REFERENCES `filledItems`(`id`) ON DELETE CASCADE ON UPDATE NO ACTION',
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      'ALTER TABLE `filledItemAttachments` DROP FOREIGN KEY `FK_401de4f46d12ecd4bf87db46646`',
    );
