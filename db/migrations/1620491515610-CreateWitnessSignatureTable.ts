  ...
  implements MigrationInterface
{
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      'ALTER TABLE `witnessSignatures` ADD CONSTRAINT `FK_ec969389efc03d53575c5d5bcc1` FOREIGN KEY (`filledContractId`) REFERENCES `filledContracts`(`id`) ON DELETE CASCADE ON UPDATE NO ACTION',
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      'ALTER TABLE `witnessSignatures` DROP FOREIGN KEY `FK_ec969389efc03d53575c5d5bcc1`',
    );
