...
<>
At Project Raccoon, accessible from <strong>{websiteUrl}</strong>, one of
our main priorities is the privacy of our visitors. This Privacy Policy document
contains types of information that is collected and recorded by Project Raccoon
and how we use it.
</>
...
collect in Project Raccoon. This policy is not applicable to any information
...
including items such as name, address, email address, and telephone number.
...
including for customer service and to provide you with updates and other
information relating to the website
- Send you emails
- Find and prevent fraud
- Log files
- Project Raccoon follows a standard procedure of using log files. These files
...
Like any other website, Project Raccoon uses 'cookies'. These cookies are used
...
Project Raccoon does not knowingly collect any Personal Identifiable Information
