At Project Raccoon, accessible from <strong>{websiteUrl}</strong>, one of our
main priorities is the privacy of our visitors. This Privacy Policy document
contains types of information that is collected and recorded by Project
Raccoon and how we use it.
