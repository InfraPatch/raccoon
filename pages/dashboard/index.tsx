...
const DashboardHomePage = () => {
  ...
  return (
    <DashboardLayout>
      <Meta title={t('dashboard:pages.home')} url="/dashboard" />
      <Columns>
        <Column>
          <Box>
            <div className="text-center">
              ...
              <div className="text-2xl my-4">{t('home.create-title')}</div>
        ...
        <Column>
          <Box>
            <div className="text-center">
              ...
              <div className="text-2xl my-4">{t('home.list-title')}</div>
        ...
        <Column>
          <Box>
            <div className="text-center">
              ...
              <div className="text-2xl my-4">{t('home.items-title')}</div>
        ...
        <Column>
          <Box>
            <div className="text-center">
              ...
              <div className="text-2xl my-4">{t('home.profile-title')}</div>
